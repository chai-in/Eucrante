...
- Cancelling a helper sends graceful termination, escalates to forced termination after a bounded delay, and is covered by an unresponsive-process fixture test.
